...
type User struct {
	...
	Pages      null.JSON `boil:"pages" json:"pages,omitempty" toml:"pages" yaml:"pages,omitempty"`
	Attributes null.JSON `boil:"attributes" json:"attributes,omitempty" toml:"attributes" yaml:"attributes,omitempty"`
	Sidebar    null.JSON `boil:"sidebar" json:"sidebar,omitempty" toml:"sidebar" yaml:"sidebar,omitempty"`
...
var UserWhere = struct {
	...
	Pages      whereHelpernull_JSON
	Attributes whereHelpernull_JSON
	Sidebar    whereHelpernull_JSON
}{
	UID:        whereHelperstring{field: "\"users\".\"uid\""},
	Pages:      whereHelpernull_JSON{field: "\"users\".\"pages\""},
	Attributes: whereHelpernull_JSON{field: "\"users\".\"attributes\""},
	Sidebar:    whereHelpernull_JSON{field: "\"users\".\"sidebar\""},
}
...
var (
	userAllColumns            = []string{"uid", "pages", "attributes", "sidebar"}
	userColumnsWithoutDefault = []string{"uid"}
	userColumnsWithDefault    = []string{"pages", "attributes", "sidebar"}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, uID string, selectCols ...string) (*User, error) {
	userObj := &User{}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, uID string) (bool, error) {
	var exists bool
...
func (o UserSlice) InsertAll(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	for _, row := range o {
		...
		if len(wlCols) == len(userAllColumns) {
			break
		}
	}
...
func (o UserSlice) UpsertAll(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) (int64, error) {
	...
	for _, row := range o {
		...
		if len(insertCols) == len(userAllColumns) {
			break
		}
	}
